...
variable "create_db_timeout" {
    description = "The timeout for create db"
    type = string
    default = "40m"
}

variable "update_db_timeout" {
    description = "The timeout for update db"
    type = string
    default = "80m"
}

variable "delete_db_timeout" {
    description = "The timeout for delete db"
    type = string
    default = "40m"
}